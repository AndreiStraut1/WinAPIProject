void clear_screen(unsigned int color) {
	unsigned int* pixel = (unsigned int*)render_state.memory; //first pixel in our buffer
...
void draw_rect(float x, float y, float half_size_x, float half_size_y, unsigned int color) {
	...
	int x0 = x - half_size_x; //left edge
	int x1 = x + half_size_x; //right edge
	int y0 = y - half_size_y; //top edge
	int y1 = y + half_size_y; //bottom edge
